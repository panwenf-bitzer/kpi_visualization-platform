<!--
 * @FileDescription: child component for SH latest 20 pcs throughput time
 * @Author: Pan,Wenfang
 * @Date: 2022/01/04
...
import {fetch_past_sh} from "../../../api/Manager_dashboard";
  ...
  setup(props) {
    ...
    const init = (() => {
      ...
      chart.value.setOption({
            title: {
              text: 'Latest 20 pcs throughput time-SH',
              left: "center",
              textStyle: {
                fontSize: 14
              }
