<!--
 * @FileDescription: child component for alu latest 20 pcs throughput time
 * @Author: Pan,Wenfang
 * @Date: 2022/01/04
...
import {fetch_past_alu} from "../../../api/Manager_dashboard";
  ...
  setup(props) {
    ...
    const init = (() => {
      ...
      chart.value.setOption({
            title: {
              text: 'Latest 20 pcs throughput time-ALU',
              left: "center",
              textStyle: {
                fontSize: 14
              }
