<!--
 * @FileDescription: child component for monthly productivity of year
 * @Author: Pan,Wenfang
 * @Date: 2022/01/04
...
import {fetch_productivity_monthly} from "../../../api/Manager_dashboard";
  ...
  props: {
   ...
   setup(props) {
    ...
    const data_fresh = (mon) => {
      fetch_productivity_monthly(query).then((res)=>{
        console.log(res)
        let data=JSON.parse(res)
        production_data.value=data
        init()
      })
