...
<!--              <el-date-picker v-model="search_item.date" value-format="YYYYMMDD" type="date" placeholder="选择日期"  class="handle-input"></el-date-picker>-->
            ...
            <h1 style="color: white;float: bottom">SH Throughput time Dashboard</h1>
          </el-col>
...
import {fetch_sh_throughput} from "../../api";
export default {
  name: "SH_Charts",
  setup() {
      ...
      const Fetch_data=(()=>{
        ...
        fetch_sh_throughput(query_daily).then((res)=> {
