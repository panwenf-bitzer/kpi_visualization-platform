...
<!--              <el-date-picker v-model="search_item.date" value-format="YYYYMMDD" type="date" placeholder="选择日期"  class="handle-input"></el-date-picker>-->
            ...
            <h1 style="color: white;float: bottom">SCR Throughput time Dashboard</h1>
...
import {fetch_scr_throughput} from "../../api";
export default {
  name: "SCR_Charts",
  setup() {
      ...
      const Fetch_data=(()=>{
        ...
        fetch_scr_throughput(query_daily).then((res)=> {
          if (res.status===200){
