...
<!--              <el-date-picker v-model="search_item.date" value-format="YYYYMMDD" type="date" placeholder="选择日期"  class="handle-input"></el-date-picker>-->
            ...
            <h1 style="color: white;float: bottom">SH Productivity Dashboard</h1>
...
import {fetch_sh_productivity} from "../../api";
export default {
  name: "P_SH_Charts",
  setup() {
      ...
      const Fetch_data=(()=>{
        ...
        fetch_sh_productivity(query_daily).then((res)=> {
          if(res.status===200){
