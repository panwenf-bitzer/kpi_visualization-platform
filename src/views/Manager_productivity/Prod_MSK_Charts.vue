<template>
    <div id="container">
          <el-row :gutter="20">
            ...
            <h1 style="color: white;float: bottom">CNC Productivity Dashboard</h1>
...
import {fetch_cnc_productivity} from "../../api";
export default {
  name: "P_MSK_Charts",
  setup() {
      ...
      const Fetch_data=(()=>{
        ...
        fetch_cnc_productivity(query_daily).then((res)=> {
          if(res.status===200){
