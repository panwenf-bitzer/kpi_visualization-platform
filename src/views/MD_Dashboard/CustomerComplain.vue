<!--
 * @FileDescription: child component for customer compaining
 * @Author: Pan,Wenfang
 * @Date: 2022/01/04
 ...
 * @LastEditTime: 2022/02/28
 -->
<template>
<div id="Gauge_CustomerComplain" style="height: 55%"></div>
</template>
...
export default {
  ...
  series: [
    ...
    const data_fresh=()=>{
       chart.value = echarts.init(document.getElementById("Gauge_CustomerComplain"))
